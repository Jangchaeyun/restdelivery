  ...
  return (
    <div className="fixed top-0 right-0 w-full md:w-375 h-screen bg-white drop-shadow-md flex flex-col z-[101]">
      <div className="w-full flex items-center justify-between p-4 cursor-pointer">
        ...
        <p className="text-textColor text-lg font-semibold">장바구니</p>
      ...
      <div className="w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col">
        <div className="w-full h-340 md:h-42 px-6 py-10 flex flex-col gap-3 overflow-y-scroll scrollbar-none">
          ...
          <div className="w-full p-1 px-2 rounded-lg bg-cartItem flex items-center gap-2">
            <img 
              src="https://firebasestorage.googleapis.com/v0/b/resturantapp-2780e.appspot.com/o/images%2F1668589067015-%EA%B9%80%EB%B0%A5.png?alt=media&token=7b6440be-01f5-4ace-8d29-e94a3cf8fccc" 
            ...
            <div className="flex flex-col gap-2">
              <p className="text-base text-gray-50">김밥</p>
              <p className="text-sm block text-gray-300 font-semibold">3500원</p>
            </div>
        ...
        <div className="w-full flex-1 bg-cartTotal rounded-t-[2rem] flex flex-col items-center justify-evenly px-8 py-2">
          ...
          <div className="w-full flex items-center justify-between">
            ...
            <p className="text-gray-400 text-lg">1000원</p>
          </div>
